...
import (
	...
	kopsschemas "github.com/sredevopsdev/terraform-provider-kops/pkg/schemas/kops"
...
func TestExpandDataSourceCluster(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := ExpandDataSourceCluster(tt.args.in)
			if diff := cmp.Diff(tt.want, got); diff != "" {
				t.Errorf("ExpandDataSourceCluster() mismatch (-want +got):\n%s", diff)
			}
		})
	}
}
...
func TestFlattenDataSourceClusterInto(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			FlattenDataSourceClusterInto(tt.args.in, got)
			if diff := cmp.Diff(tt.want, got); diff != "" {
...
func TestFlattenDataSourceCluster(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := FlattenDataSourceCluster(tt.args.in)
			if diff := cmp.Diff(tt.want, got); diff != "" {
				t.Errorf("FlattenDataSourceCluster() mismatch (-want +got):\n%s", diff)
			}
		})
